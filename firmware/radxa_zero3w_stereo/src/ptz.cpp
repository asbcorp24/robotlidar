...
void PtzController::configure(int pan_min_cdeg, int pan_max_cdeg,
    ...
    pan_min_cdeg_ = pan_min_cdeg;
    pan_max_cdeg_ = pan_max_cdeg;
    tilt_min_cdeg_ = tilt_min_cdeg;
    tilt_max_cdeg_ = tilt_max_cdeg;
    pan_min_us_ = pan_min_us;
    pan_max_us_ = pan_max_us;
    tilt_min_us_ = tilt_min_us;
    tilt_max_us_ = tilt_max_us;
    center();
}

void PtzController::center() {
    target_pan_cdeg_ = 0;
    target_tilt_cdeg_ = 0;
}
...
int PtzController::panPulseUs() const {
    return mapValue(pan_cdeg_, pan_min_cdeg_, pan_max_cdeg_, pan_min_us_, pan_max_us_);
}

int PtzController::tiltPulseUs() const {
    return mapValue(tilt_cdeg_, tilt_min_cdeg_, tilt_max_cdeg_, tilt_min_us_, tilt_max_us_);
}
